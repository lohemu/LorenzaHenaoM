...
//   return (
//     <section className="relative -mt-40 z-20 pb-16">
//       <Container>
//         <div className="relative">
//           {/* Elementos decorativos de fondo */}
//           <div className="absolute inset-0 overflow-hidden rounded-3xl">
//             <div className="absolute -top-20 -left-20 w-40 h-40 bg-coral/20 rounded-full decorative-blob opacity-90"></div>
//             <div className="absolute -bottom-16 -right-16 w-32 h-32 bg-mint/30 rounded-full decorative-blob opacity-80" style={{ animationDelay: '2s' }}></div>
//             <div className="absolute top-1/2 left-1/4 w-6 h-6 bg-lavender/40 rounded-full"></div>
//             <div className="absolute bottom-1/4 right-1/3 w-4 h-4 bg-blue-main/30 rounded-full"></div>
            
//             {/* Círculos decorativos adicionales para simular la imagen */}
//             <div className="absolute top-10 right-20 w-24 h-24 border-2 border-white/20 rounded-full"></div>
//             <div className="absolute bottom-20 left-16 w-16 h-16 border border-white/15 rounded-full"></div>
//           </div>

//           {/* Contenido principal */}
//           <div className="relative bg-gradient-to-br from-coral via-coral-dark to-lavender-dark rounded-3xl px-8 py-16 lg:px-16 lg:py-20 shadow-2xl overflow-hidden">
//             {/* Overlay para mejor legibilidad */}
//             <div className="absolute inset-0 bg-gradient-to-br from-coral/90 via-coral-dark/85 to-lavender-dark/90 rounded-3xl"></div>
...
//                         placeholder="Tu email aquí"
//                         required
//                         className="w-full px-6 py-4 rounded-2xl bg-white/95 backdrop-blur-sm border border-white/20 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-3 focus:ring-white/30 focus:border-white/40 transition-all duration-300 font-montserrat shadow-lg"
//                         disabled={isSubmitting}
//                       />
...
//                   </form>
//                 ) : (
//                   <div className="animate-scale-in bg-white/10 backdrop-blur-sm rounded-2xl px-6 py-4 max-w-lg mx-auto border border-white/20">
//                     <div className="flex items-center justify-center gap-3 text-white">
//                       <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center">
//                         <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
//                         </svg>
//                       </div>
//                       <Text color="white" size="lg" className="font-medium">
//                         ¡Te has suscrito exitosamente!
//                       </Text>
//                     </div>
//                   </div>
...
//                 <div className="flex flex-wrap items-center justify-center gap-6 text-white/70 text-sm font-montserrat">
//                   <div className="flex items-center gap-2">
//                     <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
//                     </svg>
...
//               {/* Estadísticas */}
//               <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
//                 <div className="text-center">
//                   <div className="text-2xl lg:text-3xl font-bold text-white font-montserrat mb-1">500+</div>
//                   <div className="text-white/70 text-sm font-montserrat">Suscriptores activos</div>
//                 </div>
//                 <div className="text-center">
//                   <div className="text-2xl lg:text-3xl font-bold text-white font-montserrat mb-1">2x</div>
//                   <div className="text-white/70 text-sm font-montserrat">Por semana</div>
//                 </div>
//                 <div className="text-center">
//                   <div className="text-2xl lg:text-3xl font-bold text-white font-montserrat mb-1">95%</div>
//                   <div className="text-white/70 text-sm font-montserrat">Tasa de satisfacción</div>
//                 </div>
//               </div>
//             </div>
//           </div>
