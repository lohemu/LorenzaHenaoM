...
export function TestimonialsSection() {
  ...
  return (
    <section 
      className="grid lg:grid-cols-12 gap-8 lg:gap-6 items-center min-h-[600px] bg-gray-50 rounded-3xl p-8 lg:p-12" 
      id="testimonios"
    ...
    >  
      ...
      <div className="lg:col-span-8 flex justify-center lg:justify-end">
        <div className="w-full max-w-2xl">
          {/* Usamos el componente Card con la prop testimonial */}
          <Card 
            testimonial={testimonials[currentTestimonial]}
            className="transition-all duration-700 ease-in-out transform"
          />

          {/* Controles de navegación con colores básicos */}
          <div className="flex items-center justify-center gap-6 mt-6">
            ...
            {/* Indicadores con colores básicos */}
...
// import { Heading } from '../atoms/Heading';
// import { Text } from '../atoms/Text';
// import { Card } from './../molecules/Card'; // Importamos nuestro componente Card
