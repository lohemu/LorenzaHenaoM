...
export function TestimonialsSection() {
  ...
  return (
    <section 
      className="grid lg:grid-cols-2 gap-12 lg:gap-6 items-center min-h-[600px] bg-gradient-soft-lavender rounded-3xl p-8 lg:p-12" 
      id="testimonios"
    ...
    >  
      ...
      {/* Columna 2: Carousel de testimonios */}
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-10 relative overflow-hidden glass">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center mb-8 transition-all duration-700 ease-in-out transform">
                    <Text className="text-lg lg:text-xl text-gray-700 leading-relaxed font-montserrat font-light italic mb-8">
